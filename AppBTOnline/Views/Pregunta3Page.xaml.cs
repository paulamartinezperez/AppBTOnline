...
public partial class Pregunta3Page : ContentPage
{
    Player item;
    ...
    public Pregunta3Page(PlayerDatabase playerDatabase)
	{
		InitializeComponent();
    ...
    void Cuestion()
    {
        ...
        Cuestion aux_item = aux.ElementAt(2);
    ...
    async void MyButton_Clicked(object sender, EventArgs e)
    {
        ...
        {
            Item.Intentos_3 = Item.Intentos_3 + 1;
